...
namespace RtsGame.Sim.Checksums
{
    public static class StateChecksum
    {
        ...
        private static void WriteState(CanonicalWriter writer, GameState state, GameRules rules)
        {
            ...
            writer.WriteBool(rules.EnableMovementEngineV2);
            writer.WriteBool(rules.EnableGatherEngineV2);
            ...
            foreach (Unit unit in state.EntityState.Units)
            {
                ...
                writer.WriteInt32(unit.LastNoProgressTicksWindow);
                ...
                writer.WriteInt32(unit.AssignedResourceNodeId);
                ...
                writer.WriteInt32(unit.ReservationChurnCountWindow);
                writer.WriteInt32(unit.ReservationChurnWindowStartTick);
                writer.WriteUInt16((ushort)unit.LastReservationFailureReason);
                writer.WriteInt32(unit.LastReservationFailureTick);
                writer.WriteUInt16((ushort)unit.LastGatherFallbackReason);
                writer.WriteUInt16((ushort)unit.LastMovementRetargetReason);
                ...
                writer.WriteInt32(unit.NextAttackMoveAcquireTick);
