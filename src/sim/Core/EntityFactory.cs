    ...
    public static class EntityFactory
    {
        ...
        public static int CreateUnit(GameState state, int ownerPlayerIndex, UnitTypeId unitTypeId, FixedVector2 position, bool countPopulation)
        {
            ...
            var unit = new Unit
            {
                ...
                LastReservationRetargetTick = -1,
                ReservationChurnCountWindow = 0,
                ReservationChurnWindowStartTick = -1,
                LastReservationFailureReason = ReservationAttemptFailureReason.None,
                LastReservationFailureTick = -1,
                LastGatherFallbackReason = GatherFallbackReason.None,
                LastMovementRetargetReason = MovementRetargetReason.None,
