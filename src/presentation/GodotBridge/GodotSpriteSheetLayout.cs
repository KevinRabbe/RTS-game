...
namespace RtsGame.Presentation.GodotBridge
{
    ...
    public static class GodotSpriteSheetLayout
    {
        private static readonly GodotSpriteSheetMetadata[] Metadata =
        {
            ...
            new GodotSpriteSheetMetadata(GodotSpriteAssetId.GrassTile, "GrassTile", "grass_tile_sheet.png", 4, 4, 0, false, 0),
            new GodotSpriteSheetMetadata(GodotSpriteAssetId.DirtTile, "DirtTile", "dirt_path_tile_sheet.png", 4, 4, 0, false, 0),
            new GodotSpriteSheetMetadata(GodotSpriteAssetId.RockBlocker, "RockBlocker", "rock_blocker_sheet.png", 4, 4, 0, false, 0)
        };
