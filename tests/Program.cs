    ...
    public static partial class Program
    {
        public static int Main(string[] args)
        {
            var tests = new List<TestCase>
            {
                ...
                new TestCase("combat test scenario supports attack move through facade", CombatTestScenarioSupportsAttackMoveThroughFacade),
                ...
                new TestCase("godot selection router double click owned villager selects same type", GodotSelectionRouterDoubleClickOwnedVillagerSelectsSameType),
                new TestCase("godot selection router double click owned infantry selects same type", GodotSelectionRouterDoubleClickOwnedInfantrySelectsSameType),
                new TestCase("godot selection router double click enemy does not select controllable units", GodotSelectionRouterDoubleClickEnemyDoesNotSelectControllableUnits),
                ...
                new TestCase("godot hud text includes attack move destination while engaging target", GodotHudTextIncludesAttackMoveDestinationWhileEngagingTarget),
                ...
                new TestCase("godot control group feedback formats assign text", GodotControlGroupFeedbackFormatsAssignText),
                ...
                new TestCase("godot hud text includes multiple selected control group indicators", GodotHudTextIncludesMultipleSelectedControlGroupIndicators),
                ...
                new TestCase("godot hud text includes hovered unit label when no building hover", GodotHudTextIncludesHoveredUnitLabelWhenNoBuildingHover),
                new TestCase("godot hud text prefers hovered building over hovered unit", GodotHudTextPrefersHoveredBuildingOverHoveredUnit),
                ...
                new TestCase("control group state shift add merges and dedupes", ControlGroupStateShiftAddMergesAndDedupes),
                new TestCase("control group state finds all exact match indices", ControlGroupStateFindsAllExactMatchIndices),
                new TestCase("control group state finds no matches for different selection", ControlGroupStateFindsNoMatchesForDifferentSelection),
